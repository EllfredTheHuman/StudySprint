window.filmStudyQuestions = {
    "Film Study": [
...

        {
            ...
            answers: ["The main character", "The villain", "The narrator", "The director"],
        ...
        },
        {
            ...
            answers: ["A shot showing what a character sees", "A shot of the director", "A shot of the credits", "A shot from above"],
            correctAnswer: "A shot showing what a character sees"
        },
        {
            type: "multiple",
        ...
        },
        {
            type: "written",
            question: "What is a montage?",
            acceptedAnswers: ["a sequence of edited shots", "sequence of edited shots"]
        },
        {
            type: "written",
